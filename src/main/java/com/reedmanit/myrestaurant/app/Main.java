 ...
 */
package com.reedmanit.myrestaurant.app;
...
public class Main extends Application {
    ...
    public void start(Stage stage) throws Exception {
     ...
     //   stage.getIcons().add(new Image(Main.class.getResourceAsStream("/com/reedmanit/csveditor/view/file.png")));
        ...
        scene = new Scene(loadFXML("MyRestaurantUI"));
    ...
    private static Parent loadFXML(String fxml) throws IOException {
        fxmlLoader = new FXMLLoader(Main.class.getResource("/com/reedmanit/myrestaurant/view/" + fxml + ".fxml"));
